        ...
        <form method="POST" action="" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            <div class="col">
              ...
              <input type="radio" id="html" name="cover" value="Cover">
                <label for="html">Cover</label>
                <input type="radio" id="css" name="cover" value="Origjinale">
                <label for="css">Origjinale</label>
              <input type="radio" id="css" name="cover" value="Potpuri">
                <label for="css">Potpuri</label><br>

            </div>
            <div class="col">
              <label for="tel">Platformat sociale </label><br>
              <input type="checkbox" id="facebook" name="facebook" value="Po">
              <label for="Facebook">Facebook</label><br>
              <input type="checkbox" name="Instagram" value="Po">
          ...
          <div class="form-group row">
            <div class="col">
              ...
              <input type="text" name="veper" class="tcal form-control" placeholder="Veper nga Koha" value="" autocomplete="off">
            </div>

            <div class="col">
              <label for="imei">Klienti: </label>
              <select class="js-example-basic-single w-100" data-live-search="true" name="klienti" required>
                <?php
            ...
            <div class="col">
              ...
              <select multiple class="form-control" name="platformat[]" id="exampleFormControlSelect2">
          ...
          <div class="form-group row">
            <div class="col">
              ...
              <input type="text" name="data" class="tcal form-control" value="<?php echo date("Y-m-d"); ?>">
            </div>
            <div class="col">
              <label for="imei">Gjuha:</label>
              <select name="gjuha" class="form-control">
                <option value="Shqip" selected="">Shqip (Default)</option>
          ...
          <div class="col">
            <label>Info Shtes&euml;: </label>
            <textarea id="simpleMde" name="infosh" placeholder="Info Shtes"></textarea>
          </div>
      </div>
      <br>
